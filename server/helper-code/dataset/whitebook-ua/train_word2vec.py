...
class MyCorpus(object):
    ...
    def __iter__(self):
        corpus_path = './whitebook-ua-all-utf8-clean.txt'
...
out_model = "../../../models/whitebook.lowercased.word2vec.c.text.format.500d"
...
s = model.wv.most_similar('реабілітація')
print(s)
lc = model.wv.most_similar(positive=['фізична', 'реабілітація'])
print(lc)

# model.save(out_model)

# * save/switch to the KeyedVectors instance
